...
export const Projects = () => {
  ...
  return (
    <section id="projects" className="section fade-in-up" style={{ position: "relative", overflow: "hidden" }}>
          ...
          onMouseLeave={(e) => {
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{
                ...
                <div style={{
                  fontSize: "2rem",
                  background: `linear-gradient(135deg, ${idx === 0 ? "#3b82f6 0%, #6366f1 50%, #8b5cf6 100%" : idx === 1 ? "#8b5cf6 0%, #a855f7 50%, #ec4899 100%" : idx === 2 ? "#ec4899 0%, #f43f5e 50%, #f97316 100%" : "#f59e0b 0%, #eab308 50%, #10b981 100%"})`,
                  backgroundSize: "200% 200%",
                  width: "56px",
                  height: "56px",
                  display: "flex",
                  ...
                  animation: "gradientShift 8s ease-in-out infinite, iconFloat 3s ease-in-out infinite",
